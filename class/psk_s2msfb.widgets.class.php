...
class PSK_S2MSFB_wdgt_download extends WP_Widget {
	 ...
	 * @return string HTML
	 */
	private function get_latest_downloads( /** @noinspection PhpUnusedParameterInspection */
	 ...
	 * @return string HTML
	 */
	private function get_top_downloads( /** @noinspection PhpUnusedParameterInspection */
		$widget_id, $limit, $names, $types, $display_icon, $display_time, $display_files, $display_directory_source, $filterfile, $filterdir, $show_username, $show_count, $show_hr, $show_s2alertbox ) {
...
class PSK_S2MSFB_wdgt_files extends WP_Widget {
	 ...
	 * @return string HTML
	 */
	private function get_latest_files( /** @noinspection PhpUnusedParameterInspection */
