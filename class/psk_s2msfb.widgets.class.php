...
class PSK_S2MSFB_wdgt_download extends WP_Widget {
    ...
    private static $transient_timeout                = 86400;
     ...
     * @return string HTML
     */
    private function get_latest_downloads( $widget_id , $limit , $names, $types , $display_icon , $display_time , $display_files , $display_directory_source , $filterfile , $filterdir , $show_username , $show_count , $show_hr , $show_s2alertbox) {
        ...
        if ( count($result) == 0 ) {
            ...
            foreach($result as $row) {
                ...
                if ( $filterdir ) {
                    if ( ! preg_match( $filterdir , $dir_name ) ) continue;
                }

                if ( $filterfile ) {
                    if ( ! preg_match( $filterfile , $file_name ) ) continue;
                }
     ...
     * @return string HTML
     */
    private function get_top_downloads( $widget_id , $limit , $names, $types , $display_icon , $display_time , $display_files , $display_directory_source , $filterfile , $filterdir , $show_username , $show_count , $show_hr , $show_s2alertbox) {
