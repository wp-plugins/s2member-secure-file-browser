...
SVNURL="http://plugins.svn.wordpress.org/s2member-secure-file-browser/" # Remote SVN repo on wordpress.org, with no trailing slash
SVNUSER="Potsky" # your svn username
