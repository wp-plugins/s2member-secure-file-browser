...
If you have this directory in your windows installation, put all files in `s2member-files\app_data` instead of `s2member-files` directory.
When you call the shortcode, add this option : @dirbase="/app_data/"@
That's all!
